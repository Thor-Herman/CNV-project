...
public class CodeDumper extends AbstractJavassistTool {
    ...
    protected void transform(CtClass clazz) throws Exception {
        System.out.println(
                String.format("[%s] Intercepting class %s", CodeDumper.class.getSimpleName(), clazz.getName()));
    ...
    protected void transform(CtBehavior behavior) throws Exception {
        System.out.println(
                String.format("[%s] Intercepting method %s", CodeDumper.class.getSimpleName(), behavior.getName()));
